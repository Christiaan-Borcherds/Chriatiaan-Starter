...
# Project paths
# -------------------------
PROJECT_DIR = Path("/home/christiaan/Documents/MUST/Starter Project/Christiaan - Starter/Implementation")
...
for path in [OUTPUT_DIR, MODEL_DIR, FIGURE_DIR, REPORT_DIR, PREDICTION_DIR]:
